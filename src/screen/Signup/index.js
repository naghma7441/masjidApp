    ...
    return (
        <BgImage>
                ...
                <View style={styles.textContain}>
                    ...
                    <Text style={styles.paragraph}>Welcome back! Build your prayer habbits with Athan.</Text>
                </View>
                ...
                <CustomInput
                    ...
                    <View style={{ width: '100%', alignItems: 'center' ,marginTop:30}}>
                        <View style={{ width: '100%', borderBottomWidth: 1, borderColor: 'grey' }}></View>
                        <Text
                            style={{ color: '#9D9D9D', backgroundColor: '#515151', marginTop: -10, paddingHorizontal: 10 }}
                        >or login using </Text>
                    </View>
                    ...
                    <View style={styles.socialBox}>
                        ...
                        <TouchableOpacity style={[styles.iconView, { backgroundColor: '#3963BE' }]}>
                            <FontAwesomes name="facebook-square" size={25} color={'#FFFFFF'} />
                            <Text style={{ color: '#FFFFFF', marginLeft: 7 }}>Facebook</Text>
                        </TouchableOpacity>

                    </View>
                    <TouchableOpacity style={[styles.iconView, { backgroundColor: '#FFFFFF', marginLeft: '25%' ,marginTop:10}]}>
                ...
                <TouchableOpacity ><Text style={{color:'#A7C829',marginTop:10,fontSize:16}}
